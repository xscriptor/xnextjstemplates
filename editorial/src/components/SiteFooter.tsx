    ...
    <footer className="border-t">
      <Container className="py-14">
        <div className="grid gap-10 lg:grid-cols-2">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div className="leading-tight">
                ...
                <div className="text-xs text-foreground/70">
                  {locale === "en"
                    ? "Literary publishing house template"
                    : "Plantilla para editorial literaria"}
                </div>
              </div>
            </div>
            <p className="max-w-md text-sm leading-6 text-foreground/75">
              {locale === "en"
                ? "A sober, book-inspired design system for publishing houses, imprints and catalogs."
                : "Un diseño sobrio, inspirado en libros, para editoriales, sellos y catálogos."}
            </p>
            <div className="flex flex-wrap gap-2 text-xs text-foreground/60">
              ...
              <span className="rounded-full border bg-surface px-3 py-1">EB Garamond</span>
            </div>
          </div>
        ...
        <div className="mt-12 flex flex-col gap-3 border-t pt-6 text-xs text-foreground/60 sm:flex-row sm:items-center sm:justify-between">
          <div>
            © {new Date().getFullYear()} X Editorial.{" "}
